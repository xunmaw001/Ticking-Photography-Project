          ...
          <el-form-item class="input" label="联系方式" prop="lianxifangshi">
              <el-input v-model="ruleForm.lianxifangshi" 
                placeholder="联系方式" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收费类型" prop="shoufeileixing">
          <el-input v-model="ruleForm.shoufeileixing" 
              placeholder="收费类型" clearable  :readonly="ro.shoufeileixing"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="收费价格" prop="shoufeijiage">
              <el-input v-model="ruleForm.shoufeijiage" 
                placeholder="收费价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拍摄时长" prop="paisheshizhang">
          <el-input v-model="ruleForm.paisheshizhang" 
              placeholder="拍摄时长" clearable  :readonly="ro.paisheshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拍摄时长" prop="paisheshizhang">
              <el-input v-model="ruleForm.paisheshizhang" 
                placeholder="拍摄时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.yuyueshijian" label="预约时间" prop="yuyueshijian">
              <el-input v-model="ruleForm.yuyueshijian" 
                placeholder="预约时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约地点" prop="yuyuedidian">
          <el-input v-model="ruleForm.yuyuedidian" 
              placeholder="预约地点" clearable  :readonly="ro.yuyuedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约地点" prop="yuyuedidian">
              <el-input v-model="ruleForm.yuyuedidian" 
                placeholder="预约地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
...
export default {
  ...
  computed: {
                                                                                                                        zongjine:{
                                                                                                                                                                                                                                                            get: function () {
        return 1*this.ruleForm.shoufeijiage*this.ruleForm.paisheshizhang
      }
    },
                                                                                      },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shoufeijiage = true;
            continue;
	            	            ...
	            	            if(o=='paisheshizhang'){
            this.ruleForm.paisheshizhang = obj[o];
	    this.ro.paisheshizhang = true;
            continue;
          }
	            	            if(o=='zongjine'){
