...
public class SheyingshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		SheyingshiEntity user = sheyingshiService.selectOne(new EntityWrapper<SheyingshiEntity>().eq("sheyingshizhanghao", username));
    ...
    public R register(@RequestBody SheyingshiEntity sheyingshi){
    	...
    	SheyingshiEntity user = sheyingshiService.selectOne(new EntityWrapper<SheyingshiEntity>().eq("sheyingshizhanghao", sheyingshi.getSheyingshizhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,SheyingshiEntity sheyingshi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,SheyingshiEntity sheyingshi, HttpServletRequest request){
        EntityWrapper<SheyingshiEntity> ew = new EntityWrapper<SheyingshiEntity>();
		PageUtils page = sheyingshiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, sheyingshi), params), params));
        return R.ok().put("data", page);
    }
